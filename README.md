...
To test cache eviction, start the proxy with with a lower cache size, run several `.har` files through the cache, then look at the metrics page <http://localhost:8080/metrics>
